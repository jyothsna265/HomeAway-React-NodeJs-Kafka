...
class OwnersSignUpEmail extends Component{
    ...
    render(){
        ...
        let {ownersSignUpLoginSuccess, ownersSignUpLoginError} = this.props;
        ...
        return(
            <div class="ownerssignupemail-first-div">
                ...
                <div class="row ownerssignupemail-row">
                    <div class="col-sm-11">
                        <img class="ownerssignupemail-image1" height="60" width="175" src={require("../Images/logo3.png")}/>
                    </div>
                    <div class="col-sm-1">
                    ...
                    <div class="ownerssignupemail-entire-thing">
                        ...
                        <div class="ownerssignupemail-form">
                            <div class="ownerssignupemail-div"> 
                                ...
                                <div>
                                    <label><img class="ownerssignupemail-fb" height="49" width="330" src={require('../Images/fb.png')}/></label>
                                    <label><img class="ownerssignupemail-google" height="48" width="330" src={require('../Images/google.png')}/></label>             
                                </div>
