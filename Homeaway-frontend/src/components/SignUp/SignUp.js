        ...
        return(
            <div class='signup-first-div'>
                <div class="row signup-row">
                    <div class="col-sm-11">
                        <img class="signup-image1" height="60" width="175" src={require("../Images/logo3.png")}/>
                    </div>
                    <div class="col-sm-1">
                ...
                <div class="container">
                    ...
                    <div class="signup-form">
                        <div class="signup-div">
                            ...
                            <div>
                            <label><img class="signup-fb" height="49" width="320" src={require('../Images/fb.png')}/></label>
                            <label><img class="signup-google" height="48" width="320" src={require('../Images/google.png')}/></label>             
                            </div>
