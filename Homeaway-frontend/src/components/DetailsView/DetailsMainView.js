...
class DetailsMainView extends Component {
    ...
    componentDidMount(){
        ...
        axios.get(`http://localhost:3001/DetailsMainView`, {
            params: {
                id: `${this.state.ID.id}`
            }
        })
    ...
    submitForm = (e) => {
        ...
        axios.post('http://localhost:3001/DetailsMainView',data)
            .then(response => {
                    ...
                    <div class="details-main-left"> 
                        ...
                        <div class="details-third-div">
                            <div class="row details-third-row">
                                <div class="col-sm-2">
                                    <img height="50" width="50" src={require('../Images/img1.png')}/>
                                    <h4>{propertyDetailsProptype}</h4>
                                    <h4>924 sq. ft.</h4>
                                </div>
                                <div class="col-sm-2">
                                    <img height="50" width="50" src={require('../Images/img2.png')}/>
                                    <h4>Bedrooms</h4>
                                    <h4>{propertyDetailsNoofrooms}</h4>
                                </div>
                                <div class="col-sm-2">
                                    <img height="50" width="50" src={require('../Images/img3.png')}/>
                                    <h4>Sleeps</h4>
                                    <h4>{propertyDetailsGuests}</h4>
                                </div>
                                <div class="col-sm-2">
                                    <img height="50" width="50" src={require('../Images/img4.png')}/>
                                    <h4>Bathrooms</h4>
                                    <h4>{propertyDetailsNoofbathrooms}</h4>
                                </div>
                                <div class="col-sm-2">
                                    <img height="50" width="50" src={require('../Images/img5.png')}/>
                                    <h4>Half Baths</h4>
                                    <h4>0</h4>
                                </div>
                                <div class="col-sm-2">
                                    <img height="50" width="50" src={require('../Images/img6.png')}/>
                                    <h4>Min Stay</h4>
