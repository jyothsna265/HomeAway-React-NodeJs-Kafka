...
class TravelerInbox extends Component {
    ...
    componentDidMount(){
        axios.get('http://localhost:3001/TravelerInbox')
                .then((response) => {
                ...
                console.log("Messages within Travelers Inbox",this.state.message);
            });
    ...
    render(){  
        let travMessage = this.state.message.map(message => {
            return (
                <TravelerInboxComponent>{message.ownersMsg}{message.ownersEmailID}{message.ownersFirstName}{message.ownersLastName}</TravelerInboxComponent>
            )
        })
        ...
        return(
            <div class="travelerinbox-first-div">
                ...
                <div class="row travelerinbox-row2">
                    ...
                    <div class="col-sm-1">
                        <label><Link to="/TravelerOutbox">Outbox</Link></label>
                    </div>
                    <div class="col-sm-1">
